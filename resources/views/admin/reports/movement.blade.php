    ...
    <div class="p-4 pt-4">
        ...
        <div class="mb-6 p-6 rounded-lg border border-slate-700 bg-slate-800/30">
            <h3 class="text-lg font-semibold mb-4 text-slate-100">🔍 Filter Laporan</h3>
                ...
                <form method="GET" action="{{ route('admin.reports.movement') }}" class="space-y-4">
                    <div class="grid md:grid-cols-4 gap-4">
                        ...
                        <div class="flex gap-2 items-end">
                            ...
                            <a href="{{ route('admin.reports.movement') }}" class="flex-1 text-center text-slate-200 bg-slate-700 hover:bg-slate-600 font-medium rounded-lg text-sm px-5 py-2.5 transition">
                                ...
                                <tr class="border-t border-slate-700 hover:bg-slate-900/50 transition">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center justify-center w-10 h-10 rounded-lg 
                                            {{ $movement->type === 'in' ? 'bg-emerald-950/50 text-emerald-300' : 'bg-rose-950/50 text-rose-300' }}
                                            font-bold text-sm">
                                            {{ $movement->quantity }}
                                        </span>
                                    </td>
