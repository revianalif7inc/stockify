        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div>
                    ...
                    {{-- Menampilkan pesan error khusus untuk field email, termasuk pesan dengan tag <a> dari controller --}}
                    @error('email')
                    ...
                    {{-- Menampilkan pesan success dari controller (misalnya setelah registrasi) --}}
                    @if (session('success'))
                        <div class="mt-2 text-sm text-green-600 dark:text-green-500">
                            {{ session('success') }}
                        </div>
                    @endif
                </div>
