...
@section('content')
    <div class="p-4 pt-4">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-white">Barang Keluar - Konfirmasi</h1>
            <p class="text-slate-400">Daftar barang keluar yang perlu dikonfirmasi</p>
        </div>
                    ...
                    @forelse($products as $movement)
                        <tr class="border-t border-slate-700 hover:bg-slate-900/50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('staff.stock.out.confirm', $movement->id) }}"
                                    class="inline-flex items-center gap-1 px-3 py-1 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 transition font-medium text-sm">📤
                                    Konfirmasi</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-6 text-center text-slate-400">Tidak ada barang keluar yang perlu
                                dikonfirmasi.</td>
                        </tr>
                    @endforelse
                </tbody>
